...
namespace SharpChatClient
{
    public class EncryptionProvider
    {
        ...
        public EncryptionProvider(EncryptionMethod encryptionMethod, Client client)
        {
        ...
        public string Encrypt(Packet packet)
        {
            switch(encryptionMethod)
            {
                ...
                case EncryptionMethod.RSA:
                    ...
                    packet.message = RSA.EncryptRSA(messageRSA, ServerPublicKey);
                ...
                case EncryptionMethod.VERNAM_RSA:
                    ...
                    packet.key = RSA.EncryptRSA(verrsaMessage.Key, ServerPublicKey);
                    return packet.Serialize();
            }
        ...
        public Packet Decrypt(string toDecrypt)
        {
            ...
            {
                case EncryptionMethod.NONE:
                    Packet Packet_NONE = new Packet(PacketType.MESSAGE, client.username, toDecrypt, DateTimeOffset.UtcNow.ToUnixTimeMilliseconds());
                    return Packet_NONE;
